...
public class SchematicManager {
    ...
    public List<ChestLocationData> pasteSchematic(SchematicData data, Location location) {
        List<ChestLocationData> chestLocations = new ArrayList<>();
        ...
        try {
            ...
            // Поиск табличек с [loot] и сохранение их направления
                    ...
                    for (int z = data.getClipboard().getMinimumPoint().z(); z <= data.getClipboard().getMaximumPoint().z(); z++) {
                        ...
                        if (block.getState() instanceof Sign sign) {
                            ...
                            if (lines.length > 0 && lines[0].equalsIgnoreCase("[loot]")) {
                                ...
                                BlockFace direction = BlockFace.NORTH; // По умолчанию
    ...
    public static class ChestLocationData {
        private final Location location;
        private final BlockFace direction;

        public ChestLocationData(Location location, BlockFace direction) {
